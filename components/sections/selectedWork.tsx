...
const projects = [
  {
    id: 1,
    title: "Deep Cleaning Apartemen Studio",
    category: "Residensial",
    image: "/cleaning1.jpeg",
  },
  {
    id: 2,
    title: "Pembersihan Karpet & Sofa Kantor",
    category: "Komersial",
    image: "/cleaning2.jpeg",
  },
  {
    id: 3,
    title: "Persiapan Rumah Siap Huni",
    category: "Pindahan",
    image: "/cleaning1.jpeg",
  },
  {
    id: 4,
    title: "Sanitasi Menyeluruh Restoran",
    category: "Komersial",
    image: "/cleaning2.jpeg",
  },
];
        ...
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col md:flex-row md:justify-between md:items-end gap-6 mb-16 reveal">
            <div>
              ...
              <h2 className="text-3xl md:text-4xl lg:text-5xl font-medium mt-4 leading-tight">
                Bukti Nyata Kualitas Layanan KlinBersih
              </h2>
            </div>
            <a
              href="#"
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12">
            {projects.map((project, index) => (
              <div
                key={project.id}
                className={`group cursor-pointer reveal reveal-delay-${((index % 2) + 1) * 100}`}
              >
                ...
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <Badge
                      variant="outline"
                      className="font-medium bg-background text-muted-foreground border-border"
                    >
                      {project.category}
                    </Badge>
                  </div>
